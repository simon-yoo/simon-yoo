...
function Home() {
  return (
    <>
      <div className='w-full h-full flex flex-col md:flex-row mb-40 mt-24 items-center justify-evenly shadow-2xl'>
        <div className='w-text-center m-12'>
          <Image className='' width={100} height={40} src='/Y.png' alt='' />
        </div>
        <div className=''>
